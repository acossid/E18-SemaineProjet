...
class _View_TabsPage0 extends import1.AppView<import0.TabsPage> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_4,'tabTitle','Basic Demo');
    ...
    this.renderer.setElementAttribute(this._el_6,'tabTitle','User Demo');
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_6:any = 'Basic Demo';
    ...
    const currVal_11:any = 'User Demo';
